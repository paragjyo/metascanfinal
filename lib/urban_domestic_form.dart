...
class UrbanDomestic extends StatefulWidget {
  final String title;

  const UrbanDomestic({Key? key, required this.title}) : super(key: key);
  @override
  State<UrbanDomestic> createState() => _UrbanDomesticState();
}

class _UrbanDomesticState extends State<UrbanDomestic> {
  String parag = "";
...
municipal_board TEXT DEFAULT NULL,
...
// SAVE THE FULL FORM DATA
  void _saveFullUserDataToDatabase() async {
    ...
    await database.insert(
      ...
      {
        "district": _district,
        "municipal_board": _municipal_board,
